...
import com.example.ourfarming.adapter.PostAdapter;
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!popupTitle.getText().toString().isEmpty()
                    ...
                    StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("BlogImages");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    String userImageUri;
                                    DatabaseReference ref=FirebaseDatabase.getInstance().getReference("UserInfo").child(userId);
