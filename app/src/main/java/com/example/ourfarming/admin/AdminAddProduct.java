...
public class AdminAddProduct extends AppCompatActivity {
    ...
    private DatabaseReference productsFirebaseRef,admindatabasereference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productsFirebaseRef = FirebaseDatabase.getInstance().getReference().child("Product").child("AdminProduct");
        ...
        btn_add = findViewById(R.id.adminadd_product_button);
        nameEditText = findViewById(R.id.adminadd_product_name);
        mfdEditText = findViewById(R.id.adminadd_product_mfgdate);
        expEditText = findViewById(R.id.adminadd_product_expdate);
        sellerphoneEditText = findViewById(R.id.adminadd_product_sellerphone);
        quantityEditText = findViewById(R.id.adminadd_product_quantity);
        locationEditText = findViewById(R.id.adminadd_product_locationprocuct);
        deliverablelocationEditText = findViewById(R.id.adminadd_product_delivery);
        priceEditText = findViewById(R.id.adminadd_product_price);
        descriptionEditText = findViewById(R.id.adminadd_product_detail);
        imgOne = findViewById(R.id.adminimg1);
        imgTwo = findViewById(R.id.adminimg2);
        imgThree = findViewById(R.id.adminimg3);
        imgFour = findViewById(R.id.adminimg4);
    ...
    private void displayUnits() {
        ...
        unit_spinner = findViewById(R.id.adminunit_spinner);
        defineUnits();
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    if ((uploadedImagesCount + 1) == uri_ArrayList.size()) {
                                        ...
                                        productDetail_Map.put("SellerId", "AdminProduct");
...
//                        getSupportFragmentManager().beginTransaction().replace(R.id.bottom_navigation_fragment_container, new ProductFragment()).commit();
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(AdminAddProduct.this, e.toString(), Toast.LENGTH_SHORT).show();
...
//    }
    ...
    public void openDialog(String message) {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(AdminAddProduct.this);
